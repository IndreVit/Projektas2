...
public class Paskaita5_Uzduotis_1 {
    public static void main (String[]args){
        ...
        //susikuriu objekta
        Paskaita5_Uzduotis_1 ieskauPrekiu = new Paskaita5_Uzduotis_1();
    ...
    public void paieska(){
        ...
        String[] zodziai = {"Kompiuteris"};
        //, "televizorius", "telefonas", "laikrodis", "baseinas"
        ...
        for(String paieska1 : zodziai){
           ...
           paieska25.submit();
            ...
            List<WebElement> pavadinimai = driver.findElements(By.xpath("//*[@id=\"main_container_wrapper\"]/ul[1]/li[2]/div[2]/div/h3"));
